...
export function RequestDetailContent({ requestId }: RequestDetailContentProps) {
  ...
  return (
    <div className="max-w-[1440px] mx-auto p-4 md:p-6 lg:p-8">
      ...
      <RequestDetail
        request={request}
        onApprove={isAdmin ? () => setApproveDialogOpen(true) : undefined}
        onReject={isAdmin ? () => setRejectDialogOpen(true) : undefined}
        onRevoke={isAdmin ? () => setRevokeDialogOpen(true) : undefined}
      />
