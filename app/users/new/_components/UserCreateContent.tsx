...
import { OwnerForm, OwnerFormData } from '@/components/OwnerForm';
...
interface UserCreateContentProps {
  onCancel?: () => void;
  onCreate?: (data: OwnerFormData) => void;
}

export function UserCreateContent({ onCancel, onCreate }: UserCreateContentProps) {
...
export type { OwnerFormData } from '@/components/OwnerForm';
